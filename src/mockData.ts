...
export const MOCK_USERS: User[] = [
  { id: '1', name: 'Walisson Admin', email: 'admin@redatto.com', role: 'ADMIN', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Admin' },
  { id: '2', name: 'Prof. Ricardo Santos', email: 'ricardo@redatto.com', role: 'TEACHER', avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Teacher1' },
